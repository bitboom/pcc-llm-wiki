...
Apple은 무상태 연산(stateless computation)을 PCC의 명시적 설계 요건 중 하나로 삼는다. Apple 코퍼스에서 이는 부수적인 구현 세부 사항이 아닌 핵심 설계 원칙이다. 출처: [Apple PCC 소개](../../ko/sources/apple-2024-06-10-private-cloud-compute-intro.md), [Apple PCC 보안 가이드](../../ko/sources/apple-2024-10-24-pcc-security-guide.md).
